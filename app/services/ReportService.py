        ...
        try:
            ...
            if len(all_expenses) == 0:
                return reports_pb2.ReportResponse(
                    success=True, message="No Expenses Found", report_id="?"
                )
            ...
            report_data = {
                ...
                "username": request.username,
                "date_created": date_created,
                "pdf_data": pdf_report_content,
            }

            await database.db["reports"].insert_one(report_data)
            ...
            return reports_pb2.ReportResponse(
                success=True, message="Pdf Generated and Saved!", report_id=reportId
            )
        except Exception as e:
            print(e)
            return reports_pb2.ReportResponse(
                success=False,
                message="Error in Saving Report to Database",
                report_id="#",
            )
